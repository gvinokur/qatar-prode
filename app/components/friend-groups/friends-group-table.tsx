...
import { AnimatedRankCell, AnimatedPointsCounter, StaggeredLeaderboardRow } from '../leaderboard/rank-change-animations';
                ...
                <Table sx={{ minWidth: 650 }}>
                  ...
                  <TableBody>
                    {(() => {
                      ...
                      return usersWithRanks.map((userScore, index) => {
                        ...
                        return (
                          <StaggeredLeaderboardRow
                            ...
                            rankChange={userScore.rankChange}
                          >
                            <AnimatedRankCell rank={userScore.currentRank} rankChange={userScore.rankChange} />
                            <TableCell sx={{
