...
vi.mock('../onboarding-steps', () => ({
  ...
  SamplePredictionStep: () => <div data-testid="sample-prediction-step">Sample Prediction Step</div>,
...
describe('OnboardingDialog', () => {
  ...
  describe('Step Order - Boosts Disabled', () => {
    it('excludes boost step when tournament has no boosts', () => {
      ...
      expect(screen.getByTestId('onboarding-progress')).toHaveTextContent('1/4');
    });
