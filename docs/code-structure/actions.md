...
Tournament Hub data fetching: shared page-level hub data, Action Center game cards, Leaderboard Peek widget, Recent Results widget, public tournament timing, and Stats at a Glance widget.
