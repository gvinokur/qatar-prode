...
- **PriorityAttentionState**: TypeScript interface — `{ type: PriorityAttentionType, urgentCount?: number, firstUrgentGameId?: string, msUntilMostUrgentGame?: number, completedCount: number, totalCount: number, qtIncomplete?: boolean, qtCompleted?: number, qtTotal?: number, awardsIncomplete?: boolean, awardsCompleted?: number, awardsTotal?: number, msUntilPredictionLock?: number, availableRoundName?: string, availableRoundFirstGameId?: string }`
