...
-- Playoff teams use their actual short_names as stored in the DB (playoffs settled March 31, 2026):
--   BOS = Bosnia & Herzegovina (65), SWE = Sweden (38), TUR = Turkey (22), CZE = Czech Republic (41)
--   CON = Congo (46), IRK = Iraq (57)
...
UPDATE teams SET rank = 22  WHERE short_name = 'TUR';  -- Turkey (UEFA Path C)
