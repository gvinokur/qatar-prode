...
### Layout Consistency
- [x] All tournament child pages have same max-width
...
- [x] Sidebar card links all use same icon pattern as Tables card
...
**Layout Consistency:**
1. Navigate to each page (home, rules, stats, results, friend-groups, qualified-teams, awards)
2. Verify all have same max-width (868px)
3. Verify content aligned consistently
4. Verify sidebar appears on all except qualified-teams and awards
